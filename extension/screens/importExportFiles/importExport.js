...
(function() {
    ...
    function exportSettings() {
        ...
        navigator.clipboard.writeText(exortedSettingsString)
           .then(() => {
               queryById("exportSettingsButton").innerHTML = "Settings Copied to Clipboard!";
               setTimeout(function(){
    ...
    function importSettings() {
        ...
        const importTextfieldValue = queryById("importSettingsTextField").value.trim();
    ...
    function resetSettings() {
        ...
        var arrayOfIds = [...getFeaturesArrayOfObjectIds(),
