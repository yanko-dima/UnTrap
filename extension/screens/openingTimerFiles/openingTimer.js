 (function() {
     ...
     document.querySelectorAll('#openingTimerSetButton, #openingTimerUpdateButton').forEach(element => {
        ...
        element.onclick = function() {
            ...
            var selectElement = document.getElementById("openingTimerDurationSelect");
     ...
     const intervalItems = querySelectorAll("#openingTimerScreen .modernFormBlockItemsWrapper:has(select)");
