function clearPasswordStateFull() {
    ...
    setToStorage(getConst.passwordLockingResetPeriodData, 0);
...
(function() {
     ...
     const intervalItems = querySelectorAll("#passwordLockingScreen .modernFormBlockItemsWrapper:has(select)");
    ...
    document.querySelectorAll('#passwordLockingProtectButton, #passwordLockingUpdateButton').forEach(element => {
        element.onclick = function() {
            ...
            const passwordPromptTextField = queryById("passwordPromptTextField").value;
            const passwordResetPeriodSelect = queryById("passwordResetPeriodSelect").value;
            ...
            if (isTestPassed) {
                ...
                setToStorage(getConst.passwordLockingPasswordData, passwordTextField.value);
                
                setToStorage(getConst.passwordLockingPromptData, passwordPromptTextField);
                setToStorage(getConst.passwordLockingResetPeriodData, passwordResetPeriodSelect);
